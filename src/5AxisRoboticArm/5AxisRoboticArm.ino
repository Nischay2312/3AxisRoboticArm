...
ServoLib BaseServo(BASE_SERVO_PIN, BASE_SERVO_MAX, BASE_SERVO_MIN, BASE_SERVO_SPEED, BASE_SERVO_DEF);
ServoLib LowArmServo(LOWARM_SERVO_PIN, LOWARM_SERVO_MAX, LOWARM_SERVO_MIN, LOWARM_SERVO_SPEED, LOWARM_SERVO_DEF);
ServoLib UpArmServo(UPARM_SERVO_PIN, UPARM_SERVO_MAX, UPARM_SERVO_MIN, UPARM_SERVO_SPEED, UPARM_SERVO_DEF);
ServoLib WristPitchServo(WRIST_P_SERVO_PIN, WRIST_P_SERVO_MAX, WRIST_P_SERVO_MIN, WRIST_P_SERVO_SPEED, WRIST_P_SERVO_DEF);
ServoLib WristRollServo(WRIST_R_SERVO_PIN, WRIST_R_SERVO_MAX, WRIST_R_SERVO_MIN, WRIST_R_SERVO_SPEED, WRIST_R_SERVO_DEF);
ServoLib GripperServo(GRIPPER_SERVO_PIN, GRIPPER_SERVO_MAX, GRIPPER_SERVO_MIN, GRIPPER_SERVO_SPEED, GRIPPER_SERVO_OPEN);


//Create the Controller Object
Controller RobotArmInput;
#define StickDeadZone 40
#define BaseTurnSpeed 0.07
#define LowArmTurnSpeed 0.04
#define UpArmTurnSpeed 0.03
#define WristPitchTurnSpeed 0.08
#define WristRollTurnSpeed 0.08
